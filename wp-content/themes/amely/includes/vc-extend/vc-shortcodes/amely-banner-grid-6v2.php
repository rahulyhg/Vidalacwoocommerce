 ...
 * @package Amely
 */
class WPBakeryShortCode_Amely_Banner_Grid_6v2 extends WPBakeryShortCodesContainer {

}

// Banner Grid 6
vc_map( array(
	'name'                    => esc_html__( 'Banner Grid 6 (Layout 2)', 'amely' ),
	'description'             => esc_html__( 'Group maximum 6 banners into 3 columns', 'amely' ),
	'base'                    => 'amely_banner_grid_6v2',
	'icon'                    => 'amely-element-icon-banner-grid-6v2',
