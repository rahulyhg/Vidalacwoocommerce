 ...
 * @package Amely
 */
class WPBakeryShortCode_Amely_Feature_Product extends WPBakeryShortCode {
...
// Mapping shortcode.
vc_map( array(
	'name'        => esc_html__( 'Feature Product', 'amely' ),
	'base'        => 'amely_feature_product',
	'icon'        => 'amely-element-icon-feature-product',
	'category'    => sprintf( esc_html__( 'by %s', 'amely' ), AMELY_THEME_NAME ),
	'description' => esc_html__( 'Show a single product as special product. Note: Product is simple product.',
		'amely' ),
	'params'      => array(
		array(
			'type'       => 'chosen',
