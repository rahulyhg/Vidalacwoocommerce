																											...
																											<# if ( data.value['text-align'] === 'inherit' ) { #>
																												...
																												<# } #>>
																													<label
																														...
																														<span
																															class="screen-reader-text"><?php esc_attr_e( 'Inherit', 'kirki' ); ?></span>
																													</label>
																													</input>
																													<input
																														{{{
																													...
																													<# if ( data.value['text-align'] === 'left' ) { #>
																														...
																														<# } #>
																															...
																															<label
																																...
																																<span
																																	class="screen-reader-text"><?php esc_attr_e( 'Left', 'kirki' ); ?></span>
																															</label>
																															</input>
																															<input
																																{{{
																															...
																															<# if ( data.value['text-align'] === 'center' ) { #>
																																...
																																<# } #>
																																	...
																																	<label
																																		...
																																		<span
																																			class="screen-reader-text"><?php esc_attr_e( 'Center', 'kirki' ); ?></span>
																																	</label>
																																	</input>
																																	<input
																																		{{{
																																	...
																																	<# if ( data.value['text-align'] === 'right' ) { #>
																																		...
																																		<# } #>
																																			...
																																			<label
																																				...
																																				<span
																																					class="screen-reader-text"><?php esc_attr_e( 'Right', 'kirki' ); ?></span>
																																			</label>
																																			</input>
																																			<input
																																				{{{
																																			...
																																			<# if ( data.value['text-align'] === 'justify' ) { #>
																																				...
																																				<# } #>
																																					...
																																					<label
																																						...
																																						<span
																																							class="screen-reader-text"><?php esc_attr_e( 'Justify', 'kirki' ); ?></span>
																																					</label>
																																					</input>
																										</div>
																									</div>
																														...
																														<# data.value['text-decoration'] = data.value['text-decoration'] || data['default']['text-decoration']; #>
																															<div
																																...
																																<select
																																	...
																																	id="kirki-typography-text-decoration-{{{ data.id }}}">
																																	<option
																																		value=""
																																	<# if ( '' === data.value['text-decoration'] ) { #>
																																		selected
																																		<# } #>
																																			></option>
																																			<option
																																				value="none"
																																			<# if ( 'none' === data.value['text-decoration'] ) { #>
																																				selected
																																				<# } #>
																																					><?php esc_attr_e( 'None', 'kirki' ); ?></option>
																																					<option
																																						value="underline"
																																					<# if ( 'underline' === data.value['text-decoration'] ) { #>
																																						selected
																																						<# } #>
																																							><?php esc_attr_e( 'Underline', 'kirki' ); ?></option>
																																							<option
																																								value="overline"
																																							<# if ( 'overline' === data.value['text-decoration'] ) { #>
																																								selected
																																								<# } #>
																																									><?php esc_attr_e( 'Overline', 'kirki' ); ?></option>
																																									<option
																																										value="line-through"
																																									<# if ( 'line-through' === data.value['text-decoration'] ) { #>
																																										selected
																																										<# } #>
																																											><?php esc_attr_e( 'Line-Through', 'kirki' ); ?></option>
																																											<option
																																												value="initial"
																																											<# if ( 'initial' === data.value['text-decoration'] ) { #>
																																												selected
																																												<# } #>
																																													><?php esc_attr_e( 'Initial', 'kirki' ); ?></option>
																																													<option
																																														value="inherit"
																																													<# if ( 'inherit' === data.value['text-decoration'] ) { #>
																																														selected
																																														<# } #>
																																															><?php esc_attr_e( 'Inherit', 'kirki' ); ?></option>
																																</select>
																																				...
																																				<# data.value['margin-bottom'] = data.value['margin-bottom'] || data['default']['margin-bottom']; #>
																																					<div
																																						...
																																						<input
																																							...
																																							type="text"
																																							value="{{ data.value['margin-bottom'] }}"/>
																																					</div>
																																					<# } #>
