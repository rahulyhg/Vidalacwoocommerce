...
class Kirki_Modules_Post_Meta {
	...
	public function enqueue_control_scripts() {
		...
		wp_enqueue_script( 'kirki_post_meta_previewed_controls', trailingslashit( Kirki::$url ) . 'modules/post-meta/customize-controls.js', array(
			'jquery',
			'customize-controls'
		), KIRKI_VERSION, true );
	}
	...
	public function enqueue_preview_scripts() {
		...
		wp_enqueue_script( 'kirki_post_meta_previewed_preview', trailingslashit( Kirki::$url ) . 'modules/post-meta/customize-preview.js', array(
			'jquery',
			'customize-preview'
		), KIRKI_VERSION, true );
